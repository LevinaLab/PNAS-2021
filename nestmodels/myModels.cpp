...
const std::string
myModels::name(void) const
{
  return std::string("myModels"); // Return name of the module
}

const std::string
myModels::commandstring( void ) const
{
  // Instruct the interpreter to load myModels-init.sli
  return std::string( "(myModels-init) run" );
}

//-------------------------------------------------------------------------------------
void
myModels::init( SLIInterpreter* i )
{

  
    nest::kernel().model_manager.register_node_model<adapt_lif>("adapt_lif");
